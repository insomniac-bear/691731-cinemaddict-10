...
const isFilmCardsEmpty = cards.length;

if (isFilmCardsEmpty === 0) {
  render(filmsElement, new NoCardsComponent().getElement(), RenderPosition.BEFOREEND); // Если массив карточек пуст - рендерим сообщение-заглушку
} else {
